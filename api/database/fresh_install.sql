-- ============================================================
-- SMANKO – Full Fresh Install
-- Jalankan dari: phpMyAdmin > pilih SERVER (bukan smko_db) > tab SQL
-- ============================================================

DROP DATABASE IF EXISTS `smko_db`;
...
-- ============================================================
-- TABEL 12: penilaian_keterampilan
-- ============================================================
...
-- Hash: $2y$10$GQUaD706mqVyHA2DioKGJ.AZdPGW707nXfN0NjNJ42Gjbuu30lPVq
...
-- Siswa Sample
INSERT INTO `siswa` (`nis`, `nama`, `kelas`, `jenis_kelamin`, `cabang_olahraga_id`) VALUES
...
-- Penugasan Guru (tahun_ajaran_id=2 = aktif)
